...
cp "$WORK_DIR/dist/ffmpeg/bin/avcodec-"*.dll "$APPDIR/"
cp "$WORK_DIR/dist/ffmpeg/bin/avformat-"*.dll "$APPDIR/"
cp "$WORK_DIR/dist/ffmpeg/bin/avutil-"*.dll "$APPDIR/"
cp "$WORK_DIR/dist/ffmpeg/bin/swresample-"*.dll "$APPDIR/"
cp "$WORK_DIR/dist/ffmpeg/bin/swscale-"*.dll "$APPDIR/"
