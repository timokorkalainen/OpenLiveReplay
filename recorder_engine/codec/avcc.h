...
// QByteArray when sps/pps is empty, the first SPS is shorter than 4 bytes
// (profile/compat/level are read from SPS[1..3]), or the input cannot fit in
// the fixed-width avcC count/length fields.
